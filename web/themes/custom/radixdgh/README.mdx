...
radixdgh theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of radixdgh theme and run the following commands:
`nvm use`
...
`drush en radixdgh -y`
`drush config-set system.theme default radixdgh -y`
